...
-- CreateIndex
CREATE INDEX "Professional_tenantId_fullName_idx" ON "Professional"("tenantId", "fullName");
...
-- CreateIndex
CREATE UNIQUE INDEX "SocialChannelConfig_tenantId_channel_key" ON "SocialChannelConfig"("tenantId", "channel");
...
-- AddForeignKey
ALTER TABLE "SocialChannelConfig" ADD CONSTRAINT "SocialChannelConfig_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
